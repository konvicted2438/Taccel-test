...
OUT_DIR = init_robot_demo(args, "finray_indentation_sphere2", "finray_indentation_sphere2")
...
if __name__ == "__main__":
    ...
    objects_pointy = pv.read("finray_test/sphere_vol.msh")
    ...
    initial_pointy_pos = np.array([0.78, 0.765, 0.0])
    #  0.78- sphere2  0.46-sphere1
